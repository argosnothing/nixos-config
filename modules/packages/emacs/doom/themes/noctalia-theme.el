...
(let* ((bg "#161616")
      (err "#ee5396")
      (err-container "#930643")
      (on-background "#ffffff")
      (on-err "#e6e1e5")
      (on-err-container "#ffffff")
      (on-primary "#e6e1e5")
      ...
      (outline-color "#a8a8a9")
      (outline-variant "#757576")
      (primary "#33b1ff")
      (primary-container "#005e99")
      (secondary "#42be65")
      (secondary-container "#207939")
      (shadow "#000000")
      (surface "#161616")
      ...
      (tertiary "#be95ff")
      (tertiary-container "#3b0099")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#be95ff")
      (on-success "#e6e1e5")
      (success-container "#3b0099")
      (on-success-container "#ffffff")
      ;; Map fixed colors to regular colors
      (primary-fixed "#33b1ff")
      (primary-fixed-dim "#005e99")
      (secondary-fixed "#42be65")
      (secondary-fixed-dim "#207939")
      (tertiary-fixed "#be95ff")
      (tertiary-fixed-dim "#3b0099")
      (on-primary-fixed "#e6e1e5")
      (on-primary-fixed-variant "#ffffff")
      (on-secondary-fixed "#e6e1e5")
      (on-secondary-fixed-variant "#ffffff")
      (on-tertiary-fixed "#e6e1e5")
