...
### Purpose
* Themes with stylix are generally tricky to approach. Some things applications you'll not want stylix to apply theming to. Maybe you only want that non stylix theming applied for a certain theme that has its own package for that specific application. 
