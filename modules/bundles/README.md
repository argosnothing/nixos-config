...
* Similar to base, these are modules I consider necessary for base functionality in a desktop/wm environment. For example, most applications I use make the assumption that stylix is going to be enabled, so I have it imported here. More information on how I deal with stylix and theming can be found in [README.md](modules/features/gui/themes/README.md)
