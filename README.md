...
- Parts of my config are not managed explicitly through nix. I like to edit certain things on the fly so i use [nixos quantum](https://github.com/argosnothing/nixos-quantum) to bind mount certain config files in a similar way to the impermanence module.
