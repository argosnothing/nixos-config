...
static const MonitorRule monrules[] = {
  ...
  { "DP-2",     0.5f,  1,      1,   &layouts[0], WL_OUTPUT_TRANSFORM_NORMAL,  3072, 288},
...
/* If you want to use the windows key for MODKEY, use WLR_MODIFIER_LOGO (WLR_MODIFIER_ALT)*/
//#define MODKEY WLR_MODIFIER_ALT
#define MODKEY WLR_MODIFIER_ALT

#define TAGKEYS(KEY,SKEY,TAG) \
	{ MODKEY,                    KEY,            comboview,            {.ui = 1 << TAG} }, \
	{ MODKEY|WLR_MODIFIER_CTRL,  KEY,            combotag,      {.ui = 1 << TAG} }, \
...
static const Key keys[] = {
  ...
  { MODKEY,                    XKB_KEY_e,          togglescratch,  {.v = termscratch}},
  { MODKEY,                    XKB_KEY_w,          togglescratch,  {.v = firefoxscratch}},
  { MODKEY,                    XKB_KEY_s,          togglescratch,  {.v = spotifyscratch}},
  { MODKEY,                    XKB_KEY_q,          togglescratch,  {.v = discordscratch}},
